...
import * as sty from "./PlasmicHomeCta.module.css"; // plasmic-import: WRXHryIzPKvJK/css

import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: -c9knOJC7kkBbu/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__uxpD8)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__wLnEc)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.box__i9Fga)}>
          <SphereIcon
