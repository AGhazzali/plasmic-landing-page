...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: xPO0u3U50qni9D/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box___4KloO)}
      >
        <div className={classNames(defaultcss.all, sty.box__aWnRp)}>
          <div className={classNames(defaultcss.all, sty.box__e0H6E)}>
            <p.PlasmicSlot
