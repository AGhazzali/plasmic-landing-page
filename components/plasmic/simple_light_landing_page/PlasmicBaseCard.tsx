...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: RySE89cLuaimtN/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__dcGYq, {
          [sty.box__long__dcGYqmoRpj]: hasVariant(variants, "long", "long")
        })}
      >
        <p.PlasmicSlot
          defaultContents={
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box___9F6SN, {
            [sty.box__long___9F6SNmoRpj]: hasVariant(variants, "long", "long")
          })}
        >
          <p.PlasmicSlot
            defaultContents={
