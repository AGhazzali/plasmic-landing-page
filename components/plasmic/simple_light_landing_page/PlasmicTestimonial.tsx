...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 8wpTUj0hJLFnMc/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: JVNE5V1t2lvlX3/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__erIwn)}
      >
        <div
